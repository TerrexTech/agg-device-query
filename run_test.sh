...
echo "Waiting for agg-device-cmd to initialize"
sleep 5

docker-compose up -d --build --force-recreate agg-device-query
sleep 5

docker ps -a

docker-compose up --build --force-recreate agg-device-query-test
docker ps -a
